...
class SearchCollectionList extends Reflux.Component {
          ...
          if (asset.asset_type === ASSET_TYPES.survey.id) {
            ...
            return dataInterface.getSubmissions(assetUid, limit, start, sort, fieldsToQuery)
              .then((data) => {
                ...
                console.log(`Got last submission for ${assetUid} via dataInterface: ${lastSubmissionTime}`);
  ...
  renderGroupedHeadings() {
    return (
        ...
        <bem.AssetListSorts__item m={'last_submission'} className='mdl-cell mdl-cell--1-col mdl-cell--1-col-tablet mdl-cell--1-col-phone' >
          {t('Last Submission')}
        </bem.AssetListSorts__item>
